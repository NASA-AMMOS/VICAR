...
int validate_user_parameters ( parameters *parms, int *SL, int *SS, int *SB, int *NL, int *NS, int *NB, int *nl, int *ns, int *nb);

void main44(void)
{
  int j=0,start,lineStart=0;
  int SL,SS,SB,NL,NS,NB;
  ...
  zifmessage(" ");
  zifmessage("PIC2VIC version 2019-09-06");
  zifmessage(" ");
