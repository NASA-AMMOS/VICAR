...
static LblApiElement_typ	LabelTbl[] = {
    ...
    {"VALID_MAXIMUM_PIXEL",     "INT",      LBL_OPTIONAL,
     ...
     {"EXPOSURE_COADD",                 "INT",          LBL_OPTIONAL,
        LBL_NO_CONT,    1,      1,      LBL_NULL,
        LBL_OFFSET(LblObsRequest_typ, ExposureCoadd.Value),
        LBL_OFFSET(LblObsRequest_typ, ExposureCoadd.Valid),
        LBL_NO_RETURN,  LBL_SIZE(ExposureCoadd.Value)},
        
    {"AUTO_EXPOSURE_LOWER_THRESHOLD",           "INT",  LBL_OPTIONAL,
        LBL_NO_CONT,    1,      1,      LBL_NULL,
        LBL_OFFSET(LblObsRequest_typ, AutoExposureLowerThreshold.Value),
        LBL_OFFSET(LblObsRequest_typ, AutoExposureLowerThreshold.Valid),
        LBL_NO_RETURN,  LBL_SIZE(AutoExposureLowerThreshold.Value)},

    {"AUTO_EXPOSURE_UPPER_THRESHOLD",           "INT",  LBL_OPTIONAL,
        LBL_NO_CONT,    1,      1,      LBL_NULL,
        LBL_OFFSET(LblObsRequest_typ, AutoExposureUpperThreshold.Value),
        LBL_OFFSET(LblObsRequest_typ, AutoExposureUpperThreshold.Valid),
        LBL_NO_RETURN,  LBL_SIZE(AutoExposureUpperThreshold.Value)},

    {"AUTO_EXPOSURE_LOWER_LIMIT",               "INT",  LBL_OPTIONAL,
        LBL_NO_CONT,    1,      1,      LBL_NULL,
        LBL_OFFSET(LblObsRequest_typ, AutoExposureLowerLimit.Value),
        LBL_OFFSET(LblObsRequest_typ, AutoExposureLowerLimit.Valid),
        LBL_NO_RETURN,  LBL_SIZE(AutoExposureLowerLimit.Value)},

    {"AUTO_EXPOSURE_UPPER_LIMIT",               "INT",  LBL_OPTIONAL,
        LBL_NO_CONT,    1,      1,      LBL_NULL,
        LBL_OFFSET(LblObsRequest_typ, AutoExposureUpperLimit.Value),
        LBL_OFFSET(LblObsRequest_typ, AutoExposureUpperLimit.Valid),
        LBL_NO_RETURN,  LBL_SIZE(AutoExposureUpperLimit.Value)},

    {"AUTO_EXPOSURE_ROI_LINES",          "INT",  LBL_OPTIONAL,
        LBL_NO_CONT,    1,      1,      LBL_NULL,
        LBL_OFFSET(LblObsRequest_typ, AutoExposureROISize.Value),
        LBL_OFFSET(LblObsRequest_typ, AutoExposureROISize.Valid),
        LBL_NO_RETURN,  LBL_SIZE(AutoExposureROISize.Value)},

    {"AUTO_EXPOSURE_ROI_Y_POSITION",            "INT",  LBL_OPTIONAL,
        LBL_NO_CONT,    1,      1,      LBL_NULL,
        LBL_OFFSET(LblObsRequest_typ, AutoExposureROIYPosition.Value),
        LBL_OFFSET(LblObsRequest_typ, AutoExposureROIYPosition.Valid),
        LBL_NO_RETURN,  LBL_SIZE(AutoExposureROIYPosition.Value)},

    {"HDR_EXPOSURE_TIME_DELTA",               "INT",         LBL_OPTIONAL,
        LBL_NO_CONT,    1,      1,      LBL_NULL,
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDelta[0].Value),
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDelta[0].Valid),
        LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDelta[0].Value)},

    {"HDR_EXPOSURE_TIME_DELTA",               "INT",         LBL_OPTIONAL,
        LBL_NO_CONT,    1,      2,      LBL_NULL,
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDelta[1].Value),
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDelta[1].Valid),
        LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDelta[1].Value)},

    {"HDR_EXPOSURE_TIME_DELTA",               "INT",         LBL_OPTIONAL,
        LBL_NO_CONT,    1,      3,      LBL_NULL,
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDelta[2].Value),
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDelta[2].Valid),
        LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDelta[2].Value)},

    {"HDR_EXPOSURE_TIME_DELTA",               "INT",         LBL_OPTIONAL,
        LBL_NO_CONT,    1,      4,      LBL_NULL,
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDelta[3].Value),
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDelta[3].Valid),
        LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDelta[3].Value)},

    {"HDR_EXPOSURE_TIME_DELTA",               "INT",         LBL_OPTIONAL,
        LBL_NO_CONT,    1,      5,      LBL_NULL,
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDelta[4].Value),
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDelta[4].Valid),
        LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDelta[4].Value)},

    {"HDR_EXPOSURE_TIME_DELTA",               "INT",         LBL_OPTIONAL,
        LBL_NO_CONT,    1,      6,      LBL_NULL,
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDelta[5].Value),
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDelta[5].Valid),
        LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDelta[5].Value)},

    {"HDR_EXPOSURE_TIME_DELTA",               "INT",         LBL_OPTIONAL,
        LBL_NO_CONT,    1,      7,      LBL_NULL,
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDelta[6].Value),
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDelta[6].Valid),
        LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDelta[6].Value)},

    {"HDR_EXPOSURE_TIME_DELTA__UNIT",               "STRING",         LBL_OPTIONAL,
        LBL_NO_CONT,    1,      1,      LBL_NULL,
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDeltaUnit[0].Value),
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDeltaUnit[0].Valid),
        LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDeltaUnit[0].Value)},

    {"HDR_EXPOSURE_TIME_DELTA__UNIT",               "STRING",         LBL_OPTIONAL,
        LBL_NO_CONT,    1,      2,      LBL_NULL,
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDeltaUnit[1].Value),
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDeltaUnit[1].Valid),
        LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDeltaUnit[1].Value)},

    {"HDR_EXPOSURE_TIME_DELTA__UNIT",               "STRING",         LBL_OPTIONAL,
        LBL_NO_CONT,    1,      3,      LBL_NULL,
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDeltaUnit[2].Value),
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDeltaUnit[2].Valid),
        LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDeltaUnit[2].Value)},

    {"HDR_EXPOSURE_TIME_DELTA__UNIT",               "STRING",         LBL_OPTIONAL,
        LBL_NO_CONT,    1,      4,      LBL_NULL,
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDeltaUnit[3].Value),
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDeltaUnit[3].Valid),
        LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDeltaUnit[3].Value)},

    {"HDR_EXPOSURE_TIME_DELTA__UNIT",               "STRING",         LBL_OPTIONAL,
        LBL_NO_CONT,    1,      5,      LBL_NULL,
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDeltaUnit[4].Value),
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDeltaUnit[4].Valid),
        LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDeltaUnit[4].Value)},

    {"HDR_EXPOSURE_TIME_DELTA__UNIT",               "STRING",         LBL_OPTIONAL,
        LBL_NO_CONT,    1,      6,      LBL_NULL,
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDeltaUnit[5].Value),
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDeltaUnit[5].Valid),
        LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDeltaUnit[5].Value)},

    {"HDR_EXPOSURE_TIME_DELTA__UNIT",               "STRING",         LBL_OPTIONAL,
        LBL_NO_CONT,    1,      7,      LBL_NULL,
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDeltaUnit[6].Value),
        LBL_OFFSET(LblObsRequest_typ, HdrExposureTimeDeltaUnit[6].Valid),
        LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDeltaUnit[6].Value)},

    {"HDR_FRAME_COUNT",               "INT",         LBL_OPTIONAL,
        LBL_NO_CONT,    1,      1,      LBL_NULL,
        LBL_OFFSET(LblObsRequest_typ, HdrFrameCount.Value),
        LBL_OFFSET(LblObsRequest_typ, HdrFrameCount.Valid),
        LBL_NO_RETURN,  LBL_SIZE(HdrFrameCount.Value)},

    {"HDR_ACQUISITION_MODE",               "STRING",         LBL_OPTIONAL,
        LBL_NO_CONT,    1,      1,      LBL_NULL,
        LBL_OFFSET(LblObsRequest_typ, HdrAcquisitionMode.Value),
        LBL_OFFSET(LblObsRequest_typ, HdrAcquisitionMode.Valid),
        LBL_NO_RETURN,  LBL_SIZE(HdrAcquisitionMode.Value)},

    {"OBSERVATION_NUMBER",               "INT",         LBL_OPTIONAL,
        LBL_NO_CONT,    1,      1,      LBL_NULL,
        LBL_OFFSET(LblObsRequest_typ, RmiPointNumber.Value),
        LBL_OFFSET(LblObsRequest_typ, RmiPointNumber.Valid),
        LBL_NO_RETURN,  LBL_SIZE(RmiPointNumber.Value)},

    {"PARAMETER_TABLE_ID",               "INT",         LBL_OPTIONAL,
        LBL_NO_CONT,    1,      1,      LBL_NULL,
        LBL_OFFSET(LblObsRequest_typ, RmiTableNumber.Value),
        LBL_OFFSET(LblObsRequest_typ, RmiTableNumber.Valid),
        LBL_NO_RETURN,  LBL_SIZE(RmiTableNumber.Value)},

    {"HDR_CLIP_THRESHOLD",              "INT",  LBL_OPTIONAL,
        LBL_NO_CONT,    1,      1,      LBL_NULL,
        LBL_OFFSET(LblObsRequest_typ, HdrClippingThreshold.Value),
        LBL_OFFSET(LblObsRequest_typ, HdrClippingThreshold.Valid),
        LBL_NO_RETURN,  LBL_SIZE(HdrClippingThreshold.Value)},

    {"RATIONAL_DESC",               "STRING",   LBL_OPTIONAL,
        LBL_NO_CONT,    1,  1,  LBL_NULL,
        LBL_OFFSET(LblObsRequest_typ, RationalDesc.Value),
        LBL_OFFSET(LblObsRequest_typ, RationalDesc.Valid),
        LBL_NO_RETURN,  LBL_SIZE(RationalDesc.Value)},
