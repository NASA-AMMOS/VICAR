...
static LblApiElement_typ	LabelTbl[] = {
	...
	{"ROVER_MOTION_COUNTER",		"INT",		LBL_OPTIONAL,
    	...
    	{"ROVER_MOTION_COUNTER",     "INT",      LBL_OPTIONAL,
        	...
        	LBL_OFFSET(LblInitState_typ, RoverMotionCounter[10].Value),
        	LBL_OFFSET(LblInitState_typ, RoverMotionCounter[10].Valid),
        	LBL_NO_RETURN,  LBL_SIZE(RoverMotionCounter[10].Value)},

    	{"ROVER_MOTION_COUNTER",     "INT",      LBL_OPTIONAL,
        	LBL_CONTINUE,   1,	12,	LBL_NULL,
        	LBL_OFFSET(LblInitState_typ, RoverMotionCounter[11].Value),
        	LBL_OFFSET(LblInitState_typ, RoverMotionCounter[11].Valid),
	...
	{"ROVER_MOTION_COUNTER_NAME",	"STRING",	LBL_OPTIONAL,
    	...
    	{"ROVER_MOTION_COUNTER_NAME",    "STRING",   LBL_OPTIONAL,
        	LBL_CONTINUE,   1,	11,	LBL_NULL,
        	LBL_OFFSET(LblInitState_typ, RoverMotionCounterName[10].Value),
        	LBL_OFFSET(LblInitState_typ, RoverMotionCounterName[10].Valid),
        	LBL_NO_RETURN,  LBL_SIZE(RoverMotionCounterName[10].Value)},

    	{"ROVER_MOTION_COUNTER_NAME",    "STRING",   LBL_OPTIONAL,
        	LBL_CONTINUE,   1,	12,	LBL_NULL,
        	LBL_OFFSET(LblInitState_typ, RoverMotionCounterName[11].Value),
        	LBL_OFFSET(LblInitState_typ, RoverMotionCounterName[11].Valid),
