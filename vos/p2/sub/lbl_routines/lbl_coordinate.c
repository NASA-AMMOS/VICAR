...
static LblApiElement_typ	LabelTbl[] = {
	...
	{"COORDINATE_SYSTEM_INDEX",		"INT",		LBL_OPTIONAL,
        	...
        	LBL_OFFSET(LblCoordinate_typ, CoordinateSystemIndex[10].Value),
        	LBL_OFFSET(LblCoordinate_typ, CoordinateSystemIndex[10].Valid),
        	LBL_NO_RETURN,  LBL_SIZE(CoordinateSystemIndex[10].Value)},

	{"COORDINATE_SYSTEM_INDEX",		"INT",		LBL_OPTIONAL,
        	LBL_CONTINUE,   1,	12,	LBL_NULL,
        	LBL_OFFSET(LblCoordinate_typ, CoordinateSystemIndex[11].Value),
        	LBL_OFFSET(LblCoordinate_typ, CoordinateSystemIndex[11].Valid),
        	LBL_NO_RETURN,  LBL_SIZE(CoordinateSystemIndex[11].Value)},
    ...
    {"COORDINATE_SYSTEM_INDEX_NAME",	"STRING",	LBL_OPTIONAL,
        LBL_CONTINUE,   1,	11,	LBL_NULL,
        LBL_OFFSET(LblCoordinate_typ, CoordinateSystemIndexName[10].Value),
        LBL_OFFSET(LblCoordinate_typ, CoordinateSystemIndexName[10].Valid),
        LBL_NO_RETURN,  LBL_SIZE(CoordinateSystemIndexName[10].Value)},

    {"COORDINATE_SYSTEM_INDEX_NAME",	"STRING",	LBL_OPTIONAL,
        LBL_CONTINUE,   1,	12,	LBL_NULL,
        LBL_OFFSET(LblCoordinate_typ, CoordinateSystemIndexName[11].Value),
        LBL_OFFSET(LblCoordinate_typ, CoordinateSystemIndexName[11].Valid),
        LBL_NO_RETURN,  LBL_SIZE(CoordinateSystemIndexName[11].Value)},
    ...
    {"REFERENCE_COORD_SYSTEM_INDEX",	"INT",		LBL_OPTIONAL,
        LBL_CONTINUE,   1,	11,	LBL_NULL,
        LBL_OFFSET(LblCoordinate_typ, ReferenceCoordSystemIndex[10].Value),
        LBL_OFFSET(LblCoordinate_typ, ReferenceCoordSystemIndex[10].Valid),
        LBL_NO_RETURN,  LBL_SIZE(ReferenceCoordSystemIndex[10].Value)},

    {"REFERENCE_COORD_SYSTEM_INDEX",	"INT",		LBL_OPTIONAL,
        LBL_CONTINUE,   1,	12,	LBL_NULL,
        LBL_OFFSET(LblCoordinate_typ, ReferenceCoordSystemIndex[11].Value),
        LBL_OFFSET(LblCoordinate_typ, ReferenceCoordSystemIndex[11].Valid),
        LBL_NO_RETURN,  LBL_SIZE(ReferenceCoordSystemIndex[11].Value)},

        {"POSE_QUALITY",         "STRING",       LBL_OPTIONAL,
                LBL_NO_CONT,    1,      1,      LBL_NULL,
                LBL_OFFSET(LblCoordinate_typ, PoseQuality.Value),
                LBL_OFFSET(LblCoordinate_typ, PoseQuality.Valid),
                LBL_NO_RETURN,  LBL_SIZE(PoseQuality.Value)},
	...
	{"RVR_SAVED_Q",	"REAL",	LBL_OPTIONAL,
       ...
       {"ATTITUDE_PROPAGATION_COUNTER",               "REAL",         LBL_OPTIONAL,
                LBL_NO_CONT,    1,      1,      LBL_NULL,
                LBL_OFFSET(LblCoordinate_typ, AttitudePropagationCounter.Value),
                LBL_OFFSET(LblCoordinate_typ, AttitudePropagationCounter.Valid),
                LBL_NO_RETURN,  LBL_SIZE(AttitudePropagationCounter.Value)},

       {"ATTITUDE_PROPAGATION_DURATION",               "REAL",         LBL_OPTIONAL,
                LBL_NO_CONT,    1,      1,      LBL_NULL,
                LBL_OFFSET(LblCoordinate_typ, AttitudePropagationDuration.Value),
                LBL_OFFSET(LblCoordinate_typ, AttitudePropagationDuration.Valid),
                LBL_NO_RETURN,  LBL_SIZE(AttitudePropagationDuration.Value)},
