...
static LblApiElement_typ	LabelTbl[] = {
	...
	{"REFERENCE_COORD_SYSTEM_INDEX",	"INT",		LBL_OPTIONAL,
		...
		LBL_OFFSET(LblSurfaceModel_typ, ReferenceCoordSystemIndex[10].Value),
		LBL_OFFSET(LblSurfaceModel_typ, ReferenceCoordSystemIndex[10].Valid),
		LBL_NO_RETURN,	LBL_SIZE(ReferenceCoordSystemIndex[10].Value)},

	{"REFERENCE_COORD_SYSTEM_INDEX",	"INT",		LBL_OPTIONAL,
		LBL_CONTINUE,	1,	12,	LBL_NULL,
		LBL_OFFSET(LblSurfaceModel_typ, ReferenceCoordSystemIndex[11].Value),
		LBL_OFFSET(LblSurfaceModel_typ, ReferenceCoordSystemIndex[11].Valid),
