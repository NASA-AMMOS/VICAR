...
static LblApiElement_typ	LabelTbl[] = {
	...
	{"ARTICULATION_DEVICE_ANGLE",		"REAL",		LBL_OPTIONAL,
        ...
        {"ARTICULATION_DEVICE_ANGLE",           "REAL",         LBL_OPTIONAL,
                ...
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceAngle[10].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceAngle[10].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceAngle[10].Value)},

        {"ARTICULATION_DEVICE_ANGLE",           "REAL",         LBL_OPTIONAL,
                LBL_CONTINUE,   1,      12,     LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceAngle[11].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceAngle[11].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceAngle[11].Value)},

        {"ARTICULATION_DEVICE_ANGLE",           "REAL",         LBL_OPTIONAL,
                LBL_CONTINUE,   1,      13,     LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceAngle[12].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceAngle[12].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceAngle[12].Value)},

        {"ARTICULATION_DEVICE_ANGLE",           "REAL",         LBL_OPTIONAL,
                LBL_CONTINUE,   1,      14,     LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceAngle[13].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceAngle[13].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceAngle[13].Value)},
	...
	{"ARTICULATION_DEVICE_ANGLE__UNIT",	"STRING",	LBL_OPTIONAL,
        ...
        {"ARTICULATION_DEVICE_ANGLE__UNIT",     "STRING",       LBL_OPTIONAL,
                LBL_CONTINUE,   1,      11,     LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceAngleUnit[10].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceAngleUnit[10].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceAngleUnit[10].Value)},

        {"ARTICULATION_DEVICE_ANGLE__UNIT",     "STRING",       LBL_OPTIONAL,
                LBL_CONTINUE,   1,      12,     LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceAngleUnit[11].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceAngleUnit[11].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceAngleUnit[11].Value)},

        {"ARTICULATION_DEVICE_ANGLE__UNIT",     "STRING",       LBL_OPTIONAL,
                LBL_CONTINUE,   1,      13,     LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceAngleUnit[12].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceAngleUnit[12].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceAngleUnit[12].Value)},

        {"ARTICULATION_DEVICE_ANGLE__UNIT",     "STRING",       LBL_OPTIONAL,
                LBL_CONTINUE,   1,      14,     LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceAngleUnit[13].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceAngleUnit[13].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceAngleUnit[13].Value)},
	...
	{"ARTICULATION_DEVICE_ANGLE_NAME",	"STRING",	LBL_OPTIONAL,
        ...
        {"ARTICULATION_DEVICE_ANGLE_NAME",      "STRING",       LBL_OPTIONAL,
                LBL_CONTINUE,   1,      11,     LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceAngleName[10].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceAngleName[10].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceAngleName[10].Value)},

        {"ARTICULATION_DEVICE_ANGLE_NAME",      "STRING",       LBL_OPTIONAL,
                LBL_CONTINUE,   1,      12,     LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceAngleName[11].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceAngleName[11].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceAngleName[11].Value)},

        {"ARTICULATION_DEVICE_ANGLE_NAME",      "STRING",       LBL_OPTIONAL,
                LBL_CONTINUE,   1,      13,     LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceAngleName[12].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceAngleName[12].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceAngleName[12].Value)},

        {"ARTICULATION_DEVICE_ANGLE_NAME",      "STRING",       LBL_OPTIONAL,
                LBL_CONTINUE,   1,      14,     LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceAngleName[13].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceAngleName[13].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceAngleName[13].Value)},
	...
	{"ARTICULATION_DEVICE_COUNT",		"INT",		LBL_OPTIONAL,
        ...
        {"ARTICULATION_DEVICE_COUNT",           "INT",          LBL_OPTIONAL,
                LBL_CONTINUE,   1,      11,     LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceCount[10].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceCount[10].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceCount[10].Value)},
...
/**/
	...
	{"ARTICULATION_DEVICE_TEMP_COUNT",		"INT",		LBL_OPTIONAL,
        ...
        {"ARTICULATION_DEVICE_TEMP_COUNT",        "INT",     LBL_OPTIONAL,
                LBL_CONTINUE,   1,  6,  LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempCount[5].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempCount[5].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceTempCount[5].Value)},
    
        {"ARTICULATION_DEVICE_TEMP_COUNT",        "INT",     LBL_OPTIONAL,
                LBL_CONTINUE,   1,  7,  LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempCount[6].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempCount[6].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceTempCount[6].Value)},

        {"ARTICULATION_DEVICE_TEMP_COUNT",        "INT",     LBL_OPTIONAL,
                LBL_CONTINUE,   1,  8,  LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempCount[7].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempCount[7].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceTempCount[7].Value)},

        {"ARTICULATION_DEVICE_TEMP_COUNT",        "INT",     LBL_OPTIONAL,
                LBL_CONTINUE,   1,  9,  LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempCount[8].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempCount[8].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceTempCount[8].Value)},

        {"ARTICULATION_DEVICE_TEMP_COUNT",        "INT",     LBL_OPTIONAL,
                LBL_CONTINUE,   1,  10,  LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempCount[9].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempCount[9].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceTempCount[9].Value)},
	...
	{"ARTICULATION_DEVICE_TEMP",		"REAL",		LBL_OPTIONAL,
        ...
        {"ARTICULATION_DEVICE_TEMP",        "REAL",     LBL_OPTIONAL,
                LBL_CONTINUE,   1,  6,  LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTemp[5].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTemp[5].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceTemp[5].Value)},

        {"ARTICULATION_DEVICE_TEMP",        "REAL",     LBL_OPTIONAL,
                LBL_CONTINUE,   1,  7,  LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTemp[6].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTemp[6].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceTemp[6].Value)},

        {"ARTICULATION_DEVICE_TEMP",        "REAL",     LBL_OPTIONAL,
                LBL_CONTINUE,   1,  8,  LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTemp[7].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTemp[7].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceTemp[7].Value)},

        {"ARTICULATION_DEVICE_TEMP",        "REAL",     LBL_OPTIONAL,
                LBL_CONTINUE,   1,  9,  LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTemp[8].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTemp[8].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceTemp[8].Value)},

        {"ARTICULATION_DEVICE_TEMP",        "REAL",     LBL_OPTIONAL,
                LBL_CONTINUE,   1,  10,  LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTemp[9].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTemp[9].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceTemp[9].Value)},
	...
	{"ARTICULATION_DEVICE_TEMP__UNIT",	"STRING",	LBL_OPTIONAL,
        ...
        {"ARTICULATION_DEVICE_TEMP__UNIT",  "STRING",   LBL_OPTIONAL,
                LBL_CONTINUE,   1,  6,  LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempUnit[5].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempUnit[5].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceTempUnit[5].Value)},

        {"ARTICULATION_DEVICE_TEMP__UNIT",  "STRING",   LBL_OPTIONAL,
                LBL_CONTINUE,   1,  7,  LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempUnit[6].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempUnit[6].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceTempUnit[6].Value)},

        {"ARTICULATION_DEVICE_TEMP__UNIT",  "STRING",   LBL_OPTIONAL,
                LBL_CONTINUE,   1,  8,  LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempUnit[7].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempUnit[7].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceTempUnit[7].Value)},

        {"ARTICULATION_DEVICE_TEMP__UNIT",  "STRING",   LBL_OPTIONAL,
                LBL_CONTINUE,   1,  9,  LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempUnit[8].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempUnit[8].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceTempUnit[8].Value)},

        {"ARTICULATION_DEVICE_TEMP__UNIT",  "STRING",   LBL_OPTIONAL,
                LBL_CONTINUE,   1,  10,  LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempUnit[9].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempUnit[9].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceTempUnit[9].Value)},
	...
	{"ARTICULATION_DEVICE_TEMP_NAME",	"STRING",	LBL_OPTIONAL,
        ...
        {"ARTICULATION_DEVICE_TEMP_NAME",   "STRING",   LBL_OPTIONAL,
                LBL_CONTINUE,   1,  6,  LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempName[5].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempName[5].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceTempName[5].Value)},

        {"ARTICULATION_DEVICE_TEMP_NAME",   "STRING",   LBL_OPTIONAL,
                LBL_CONTINUE,   1,  7,  LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempName[6].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempName[6].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceTempName[6].Value)},

        {"ARTICULATION_DEVICE_TEMP_NAME",   "STRING",   LBL_OPTIONAL,
                LBL_CONTINUE,   1,  8,  LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempName[7].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempName[7].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceTempName[7].Value)},

        {"ARTICULATION_DEVICE_TEMP_NAME",   "STRING",   LBL_OPTIONAL,
                LBL_CONTINUE,   1,  9,  LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempName[8].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempName[8].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceTempName[8].Value)},

        {"ARTICULATION_DEVICE_TEMP_NAME",   "STRING",   LBL_OPTIONAL,
                LBL_CONTINUE,   1,  10,  LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempName[9].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceTempName[9].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceTempName[9].Value)},
	...
	{"ARTICULATION_DEVICE_STATE_NAME",		"STRING",	LBL_OPTIONAL,
        ...
        {"ART_DEV_COMPONENT_STATE",                "STRING",       LBL_OPTIONAL,
                LBL_NO_CONT,    1,      1,      LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentState[0].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentState[0].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceComponentState[0].Value)},

        {"ART_DEV_COMPONENT_STATE",                "STRING",       LBL_OPTIONAL,
                LBL_CONTINUE,   1,      2,      LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentState[1].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentState[1].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceComponentState[1].Value)},

        {"ART_DEV_COMPONENT_STATE",                "STRING",       LBL_OPTIONAL,
                LBL_CONTINUE,   1,      3,      LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentState[2].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentState[2].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceComponentState[2].Value)},

        {"ART_DEV_COMPONENT_STATE",                "STRING",       LBL_OPTIONAL,
                LBL_CONTINUE,   1,      4,      LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentState[3].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentState[3].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceComponentState[3].Value)},

        {"ART_DEV_COMPONENT_STATE",                "STRING",       LBL_OPTIONAL,
                LBL_CONTINUE,   1,      5,      LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentState[4].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentState[4].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceComponentState[4].Value)},

        {"ART_DEV_COMPONENT_STATE",                "STRING",       LBL_OPTIONAL,
                LBL_CONTINUE,   1,      6,      LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentState[5].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentState[5].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceComponentState[5].Value)},

        {"ART_DEV_COMPONENT_STATE",                "STRING",       LBL_OPTIONAL,
                LBL_CONTINUE,   1,      7,      LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentState[6].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentState[6].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceComponentState[6].Value)},

        {"ART_DEV_COMPONENT_STATE",                "STRING",       LBL_OPTIONAL,
                LBL_CONTINUE,   1,      8,      LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentState[7].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentState[7].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceComponentState[7].Value)},

        {"ART_DEV_COMPONENT_STATE",                "STRING",       LBL_OPTIONAL,
                LBL_CONTINUE,   1,      9,      LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentState[8].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentState[8].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceComponentState[8].Value)},

        {"ART_DEV_COMPONENT_STATE",                "STRING",       LBL_OPTIONAL,
                LBL_CONTINUE,   1,      10,     LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentState[9].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentState[9].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceComponentState[9].Value)},

        {"ART_DEV_COMPONENT_STATE",                "STRING",       LBL_OPTIONAL,
                LBL_CONTINUE,   1,      11,     LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentState[10].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentState[10].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceComponentState[10].Value)},

        {"ART_DEV_COMPONENT_STATE",                "STRING",       LBL_OPTIONAL,
                LBL_CONTINUE,   1,      12,     LBL_NULL,
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentState[11].Value),
                LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentState[11].Valid),
                LBL_NO_RETURN,  LBL_SIZE(ArticulationDeviceComponentState[11].Value)},

	{"ART_DEV_COMPONENT_STATE_NAME",		"STRING",	LBL_OPTIONAL,
		LBL_NO_CONT,	1,	1,	LBL_NULL,
		LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentStateName[0].Value),
		LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentStateName[0].Valid),
		LBL_NO_RETURN,	LBL_SIZE(ArticulationDeviceComponentStateName[0].Value)},

	{"ART_DEV_COMPONENT_STATE_NAME",		"STRING",	LBL_OPTIONAL,
		LBL_CONTINUE,	1,	2,	LBL_NULL,
		LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentStateName[1].Value),
		LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentStateName[1].Valid),
		LBL_NO_RETURN,	LBL_SIZE(ArticulationDeviceComponentStateName[1].Value)},

	{"ART_DEV_COMPONENT_STATE_NAME",		"STRING",	LBL_OPTIONAL,
		LBL_CONTINUE,	1,	3,	LBL_NULL,
		LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentStateName[2].Value),
		LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentStateName[2].Valid),
		LBL_NO_RETURN,	LBL_SIZE(ArticulationDeviceComponentStateName[2].Value)},

	{"ART_DEV_COMPONENT_STATE_NAME",		"STRING",	LBL_OPTIONAL,
		LBL_CONTINUE,	1,	4,	LBL_NULL,
		LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentStateName[3].Value),
		LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentStateName[3].Valid),
		LBL_NO_RETURN,	LBL_SIZE(ArticulationDeviceComponentStateName[3].Value)},

	{"ART_DEV_COMPONENT_STATE_NAME",		"STRING",	LBL_OPTIONAL,
		LBL_CONTINUE,	1,	5,	LBL_NULL,
		LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentStateName[4].Value),
		LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentStateName[4].Valid),
		LBL_NO_RETURN,	LBL_SIZE(ArticulationDeviceComponentStateName[4].Value)},

	{"ART_DEV_COMPONENT_STATE_NAME",		"STRING",	LBL_OPTIONAL,
		LBL_CONTINUE,	1,	6,	LBL_NULL,
		LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentStateName[5].Value),
		LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentStateName[5].Valid),
		LBL_NO_RETURN,	LBL_SIZE(ArticulationDeviceComponentStateName[5].Value)},

	{"ART_DEV_COMPONENT_STATE_NAME",		"STRING",	LBL_OPTIONAL,
		LBL_CONTINUE,	1,	7,	LBL_NULL,
		LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentStateName[6].Value),
		LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentStateName[6].Valid),
		LBL_NO_RETURN,	LBL_SIZE(ArticulationDeviceComponentStateName[6].Value)},

	{"ART_DEV_COMPONENT_STATE_NAME",		"STRING",	LBL_OPTIONAL,
		LBL_CONTINUE,	1,	8,	LBL_NULL,
		LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentStateName[7].Value),
		LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentStateName[7].Valid),
		LBL_NO_RETURN,	LBL_SIZE(ArticulationDeviceComponentStateName[7].Value)},

	{"ART_DEV_COMPONENT_STATE_NAME",		"STRING",	LBL_OPTIONAL,
		LBL_CONTINUE,	1,	9,	LBL_NULL,
		LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentStateName[8].Value),
		LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentStateName[8].Valid),
		LBL_NO_RETURN,	LBL_SIZE(ArticulationDeviceComponentStateName[8].Value)},

	{"ART_DEV_COMPONENT_STATE_NAME",		"STRING",	LBL_OPTIONAL,
		LBL_CONTINUE,	1,	10,	LBL_NULL,
		LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentStateName[9].Value),
		LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentStateName[9].Valid),
		LBL_NO_RETURN,	LBL_SIZE(ArticulationDeviceComponentStateName[9].Value)},

	{"ART_DEV_COMPONENT_STATE_NAME",		"STRING",	LBL_OPTIONAL,
		LBL_CONTINUE,	1,	11,	LBL_NULL,
		LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentStateName[10].Value),
		LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentStateName[10].Valid),
		LBL_NO_RETURN,	LBL_SIZE(ArticulationDeviceComponentStateName[10].Value)},

	{"ART_DEV_COMPONENT_STATE_NAME",		"STRING",	LBL_OPTIONAL,
		LBL_CONTINUE,	1,	12,	LBL_NULL,
		LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentStateName[11].Value),
		LBL_OFFSET(LblArticulation_typ, ArticulationDeviceComponentStateName[11].Valid),
		LBL_NO_RETURN,	LBL_SIZE(ArticulationDeviceComponentStateName[11].Value)},
	...
	{"ARTICULATION_DEVICE_PHASE",		"STRING",	LBL_OPTIONAL,
        ...
        {"DEVICE_POSE_QUATERNION",                "REAL",         LBL_OPTIONAL,
                LBL_NO_CONT,    1,      1,      LBL_NULL,
        LBL_OFFSET(LblArticulation_typ, DevicePoseQuaternion[0].Value),
                LBL_OFFSET(LblArticulation_typ, DevicePoseQuaternion[0].Valid),
                LBL_NO_RETURN,  LBL_SIZE(DevicePoseQuaternion[0].Value)},

        {"DEVICE_POSE_QUATERNION",                "REAL",         LBL_OPTIONAL,
                LBL_NO_CONT,    1,      2,      LBL_NULL,
        LBL_OFFSET(LblArticulation_typ, DevicePoseQuaternion[1].Value),
                LBL_OFFSET(LblArticulation_typ, DevicePoseQuaternion[1].Valid),
                LBL_NO_RETURN,  LBL_SIZE(DevicePoseQuaternion[1].Value)},

        {"DEVICE_POSE_QUATERNION",                "REAL",         LBL_OPTIONAL,
                LBL_NO_CONT,    1,      3,      LBL_NULL,
        LBL_OFFSET(LblArticulation_typ, DevicePoseQuaternion[2].Value),
                LBL_OFFSET(LblArticulation_typ, DevicePoseQuaternion[2].Valid),
                LBL_NO_RETURN,  LBL_SIZE(DevicePoseQuaternion[2].Value)},

        {"DEVICE_POSE_QUATERNION",                "REAL",         LBL_OPTIONAL,
                LBL_NO_CONT,    1,      4,      LBL_NULL,
        LBL_OFFSET(LblArticulation_typ, DevicePoseQuaternion[3].Value),
                LBL_OFFSET(LblArticulation_typ, DevicePoseQuaternion[3].Valid),
                LBL_NO_RETURN,  LBL_SIZE(DevicePoseQuaternion[3].Value)},

        {"DEVICE_POSE_NAME",           "STRING",       LBL_OPTIONAL,
                LBL_NO_CONT,    1,      1,      LBL_NULL,
        LBL_OFFSET(LblArticulation_typ, DevicePoseName.Value),
        LBL_OFFSET(LblArticulation_typ, DevicePoseName.Valid),
                LBL_NO_RETURN,  LBL_SIZE(DevicePoseName.Value)},
