...
static LblApiElement_typ	LabelTbl[] = {
	...
	{"DETECTOR_FIRST_LINE",			"INT",		LBL_OPTIONAL,
        ...
        {"DETECTOR_FIRST_LINE_SAMPLE",                 "INT",          LBL_OPTIONAL,
                LBL_NO_CONT,    1,      1,      LBL_NULL,
                LBL_OFFSET(LblInstrumentState_typ, DetectorFirstLineSample.Value),
                LBL_OFFSET(LblInstrumentState_typ, DetectorFirstLineSample.Valid),
                LBL_NO_RETURN,  LBL_SIZE(DetectorFirstLineSample.Value)},
	...
	{"DETECTOR_LINE_SAMPLES",			"INT",		LBL_OPTIONAL,
		LBL_NO_CONT,	1,	1,	LBL_NULL,
		LBL_OFFSET(LblInstrumentState_typ, DetectorLineSamples.Value),
		LBL_OFFSET(LblInstrumentState_typ, DetectorLineSamples.Valid),
		LBL_NO_RETURN,	LBL_SIZE(DetectorLineSamples.Value)},
	...
	{"DETECTOR_TO_IMAGE_ROTATION",		"REAL",		LBL_OPTIONAL,
        ...
        {"DETECTOR_TO_IMAGE_FLIP",          "STRING",         LBL_OPTIONAL,
                LBL_NO_CONT,    1,      1,      LBL_NULL,
                LBL_OFFSET(LblInstrumentState_typ, DetectorToImageFlip.Value),
                LBL_OFFSET(LblInstrumentState_typ, DetectorToImageFlip.Valid),
                LBL_NO_RETURN,  LBL_SIZE(DetectorToImageFlip.Value)},
	...
	{"INSTRUMENT_FOCAL_LENGTH_COUNT",	"INT",		LBL_OPTIONAL,
        ...
        {"FOCUS_POSITION_COUNT",        "INT",       LBL_OPTIONAL,
                LBL_NO_CONT,    1,  1,  LBL_NULL,
                LBL_OFFSET(LblInstrumentState_typ, FocusPositionCount.Value),
                LBL_OFFSET(LblInstrumentState_typ, FocusPositionCount.Valid),
                LBL_NO_RETURN,  LBL_SIZE(FocusPositionCount.Value)},

        {"INSTRUMENT_ZOOM_POSITION",        "INT",       LBL_OPTIONAL,
                LBL_NO_CONT,    1,  1,  LBL_NULL,
                LBL_OFFSET(LblInstrumentState_typ, InstrumentZoomPosition.Value),
                LBL_OFFSET(LblInstrumentState_typ, InstrumentZoomPosition.Valid),
                LBL_NO_RETURN,  LBL_SIZE(InstrumentZoomPosition.Value)},
    ...
    {"ONBOARD_COLOR_MATRIX",      "REAL",      LBL_OPTIONAL,
     ...
     {"EXPOSURE_COADD",			"INT",		LBL_OPTIONAL,
	LBL_NO_CONT,	1,	1,	LBL_NULL,
	LBL_OFFSET(LblInstrumentState_typ, ExposureCoadd.Value),
	LBL_OFFSET(LblInstrumentState_typ, ExposureCoadd.Valid),
	LBL_NO_RETURN,	LBL_SIZE(ExposureCoadd.Value)},

     {"EXPOSURE_READOUT_COUNT",                 "INT",          LBL_OPTIONAL,
        LBL_NO_CONT,    1,      1,      LBL_NULL,
        LBL_OFFSET(LblInstrumentState_typ, ExposureReadoutCount.Value),
        LBL_OFFSET(LblInstrumentState_typ, ExposureReadoutCount.Valid),
        LBL_NO_RETURN,  LBL_SIZE(ExposureReadoutCount.Value)},

    {"DAC_OFFSET_NUMBER",			"INT",	LBL_OPTIONAL,
		LBL_NO_CONT,	1,	1,	LBL_NULL,
		LBL_OFFSET(LblInstrumentState_typ, DacOffsetNumber.Value),
		LBL_OFFSET(LblInstrumentState_typ, DacOffsetNumber.Valid),
		LBL_NO_RETURN,	LBL_SIZE(OffsetNumber.Value)},

	{"DAC_GAIN_NUMBER",				"INT",	LBL_OPTIONAL,
		LBL_NO_CONT,	1,	1,	LBL_NULL,
		LBL_OFFSET(LblInstrumentState_typ, DacGainNumber.Value),
		LBL_OFFSET(LblInstrumentState_typ, DacGainNumber.Valid),
		LBL_NO_RETURN,	LBL_SIZE(OffsetNumber.Value)},

	{"INSTRUMENT_DURATION",            "STRING",     LBL_OPTIONAL,
        LBL_NO_CONT,    1,  1,  LBL_NULL,
        LBL_OFFSET(LblInstrumentState_typ, InstrumentDuration[0].Value),
        LBL_OFFSET(LblInstrumentState_typ, InstrumentDuration[0].Valid),
        LBL_NO_RETURN,  LBL_SIZE(InstrumentDuration[0].Value)},

    {"INSTRUMENT_DURATION",            "STRING",     LBL_OPTIONAL,
        LBL_NO_CONT,    1,  2,  LBL_NULL,
        LBL_OFFSET(LblInstrumentState_typ, InstrumentDuration[1].Value),
        LBL_OFFSET(LblInstrumentState_typ, InstrumentDuration[1].Valid),
        LBL_NO_RETURN,  LBL_SIZE(InstrumentDuration[1].Value)},

    {"INSTRUMENT_DURATION",            "STRING",     LBL_OPTIONAL,
        LBL_NO_CONT,    1,  3,  LBL_NULL,
        LBL_OFFSET(LblInstrumentState_typ, InstrumentDuration[2].Value),
        LBL_OFFSET(LblInstrumentState_typ, InstrumentDuration[2].Valid),
        LBL_NO_RETURN,  LBL_SIZE(InstrumentDuration[2].Value)},
   
    {"INSTRUMENT_DURATION",            "STRING",     LBL_OPTIONAL,
        LBL_NO_CONT,    1,  4,  LBL_NULL,
        LBL_OFFSET(LblInstrumentState_typ, InstrumentDuration[3].Value),
        LBL_OFFSET(LblInstrumentState_typ, InstrumentDuration[3].Valid),
        LBL_NO_RETURN,  LBL_SIZE(InstrumentDuration[3].Value)}, 

    {"INSTRUMENT_DURATION",            "STRING",     LBL_OPTIONAL,
        LBL_NO_CONT,    1,  5,  LBL_NULL,
        LBL_OFFSET(LblInstrumentState_typ, InstrumentDuration[4].Value),
        LBL_OFFSET(LblInstrumentState_typ, InstrumentDuration[4].Valid),
        LBL_NO_RETURN,  LBL_SIZE(InstrumentDuration[4].Value)},

    {"INSTRUMENT_DURATION",            "STRING",     LBL_OPTIONAL,
        LBL_NO_CONT,    1,  6,  LBL_NULL,
        LBL_OFFSET(LblInstrumentState_typ, InstrumentDuration[5].Value),
        LBL_OFFSET(LblInstrumentState_typ, InstrumentDuration[5].Valid),
        LBL_NO_RETURN,  LBL_SIZE(InstrumentDuration[5].Value)},

    {"INSTRUMENT_DURATION",            "STRING",     LBL_OPTIONAL,
        LBL_NO_CONT,    1,  7,  LBL_NULL,
        LBL_OFFSET(LblInstrumentState_typ, InstrumentDuration[6].Value),
        LBL_OFFSET(LblInstrumentState_typ, InstrumentDuration[6].Valid),
        LBL_NO_RETURN,  LBL_SIZE(InstrumentDuration[6].Value)},

    {"INSTRUMENT_DURATION",            "STRING",     LBL_OPTIONAL,
        LBL_NO_CONT,    1,  8,  LBL_NULL,
        LBL_OFFSET(LblInstrumentState_typ, InstrumentDuration[7].Value),
        LBL_OFFSET(LblInstrumentState_typ, InstrumentDuration[7].Valid),
        LBL_NO_RETURN,  LBL_SIZE(InstrumentDuration[7].Value)},

	{"INSTRUMENT_CURRENT",		   "STRING",		LBL_OPTIONAL,
		LBL_NO_CONT,	1,	1,	LBL_NULL,
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[0].Value),
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[0].Valid),
		LBL_NO_RETURN,	LBL_SIZE(InstrumentCurrent[0].Value)},
   
    {"INSTRUMENT_CURRENT",           "STRING",        LBL_OPTIONAL,
        LBL_NO_CONT,    1,  2,  LBL_NULL,
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[1].Value),
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[1].Valid),
        LBL_NO_RETURN,  LBL_SIZE(InstrumentCurrent[1].Value)},

    {"INSTRUMENT_CURRENT",           "STRING",        LBL_OPTIONAL,
        LBL_NO_CONT,    1,  3,  LBL_NULL,
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[2].Value),
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[2].Valid),
        LBL_NO_RETURN,  LBL_SIZE(InstrumentCurrent[2].Value)},

    {"INSTRUMENT_CURRENT",           "STRING",        LBL_OPTIONAL,
        LBL_NO_CONT,    1,  4,  LBL_NULL,
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[3].Value),
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[3].Valid),
        LBL_NO_RETURN,  LBL_SIZE(InstrumentCurrent[3].Value)},

    {"INSTRUMENT_CURRENT",           "STRING",        LBL_OPTIONAL,
        LBL_NO_CONT,    1,  5,  LBL_NULL,
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[4].Value),
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[4].Valid),
        LBL_NO_RETURN,  LBL_SIZE(InstrumentCurrent[4].Value)},

    {"INSTRUMENT_CURRENT",           "STRING",        LBL_OPTIONAL,
        LBL_NO_CONT,    1,  6,  LBL_NULL,
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[5].Value),
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[5].Valid),
        LBL_NO_RETURN,  LBL_SIZE(InstrumentCurrent[5].Value)},

    {"INSTRUMENT_CURRENT",           "STRING",        LBL_OPTIONAL,
        LBL_NO_CONT,    1,  7,  LBL_NULL,
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[6].Value),
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[6].Valid),
        LBL_NO_RETURN,  LBL_SIZE(InstrumentCurrent[6].Value)},

    {"INSTRUMENT_CURRENT",           "STRING",        LBL_OPTIONAL,
        LBL_NO_CONT,    1,  8,  LBL_NULL,
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[7].Value),
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[7].Valid),
        LBL_NO_RETURN,  LBL_SIZE(InstrumentCurrent[7].Value)},

    {"INSTRUMENT_CURRENT",           "STRING",        LBL_OPTIONAL,
        LBL_NO_CONT,    1,  9,  LBL_NULL,
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[8].Value),
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[8].Valid),
        LBL_NO_RETURN,  LBL_SIZE(InstrumentCurrent[8].Value)},

    {"INSTRUMENT_CURRENT",           "STRING",        LBL_OPTIONAL,
        LBL_NO_CONT,    1,  10,  LBL_NULL,
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[9].Value),
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[9].Valid),
        LBL_NO_RETURN,  LBL_SIZE(InstrumentCurrent[9].Value)},

    {"INSTRUMENT_CURRENT",           "STRING",        LBL_OPTIONAL,
        LBL_NO_CONT,    1,  11,  LBL_NULL,
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[10].Value),
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[10].Valid),
        LBL_NO_RETURN,  LBL_SIZE(InstrumentCurrent[10].Value)},

    {"INSTRUMENT_CURRENT",           "STRING",        LBL_OPTIONAL,
        LBL_NO_CONT,    1,  12,  LBL_NULL,
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[11].Value),
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[11].Valid),
        LBL_NO_RETURN,  LBL_SIZE(InstrumentCurrent[11].Value)},

    {"INSTRUMENT_CURRENT",           "STRING",        LBL_OPTIONAL,
        LBL_NO_CONT,    1,  13,  LBL_NULL,
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[12].Value),
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[12].Valid),
        LBL_NO_RETURN,  LBL_SIZE(InstrumentCurrent[12].Value)},

    {"INSTRUMENT_CURRENT",           "STRING",        LBL_OPTIONAL,
        LBL_NO_CONT,    1,  14,  LBL_NULL,
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[13].Value),
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[13].Valid),
        LBL_NO_RETURN,  LBL_SIZE(InstrumentCurrent[13].Value)},

    {"INSTRUMENT_CURRENT",           "STRING",        LBL_OPTIONAL,
        LBL_NO_CONT,    1,  15,  LBL_NULL,
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[14].Value),
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[14].Valid),
        LBL_NO_RETURN,  LBL_SIZE(InstrumentCurrent[14].Value)},

    {"INSTRUMENT_CURRENT",           "STRING",        LBL_OPTIONAL,
        LBL_NO_CONT,    1,  16,  LBL_NULL,
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[15].Value),
        LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrent[15].Valid),
        LBL_NO_RETURN,  LBL_SIZE(InstrumentCurrent[15].Value)},

    {"INSTRUMENT_CURRENT_NAME",		"STRING",		LBL_OPTIONAL,
		LBL_NO_CONT,	1,	1,	LBL_NULL,
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[0].Value),
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[0].Valid),
		LBL_NO_RETURN,	LBL_SIZE(InstrumentCurrentName[0].Value)},

	{"INSTRUMENT_CURRENT_NAME",		"STRING",		LBL_OPTIONAL,
		LBL_NO_CONT,	1,	2,	LBL_NULL,
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[1].Value),
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[1].Valid),
		LBL_NO_RETURN,	LBL_SIZE(InstrumentCurrentName[1].Value)},

	{"INSTRUMENT_CURRENT_NAME",		"STRING",		LBL_OPTIONAL,
		LBL_NO_CONT,	1,	3,	LBL_NULL,
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[2].Value),
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[2].Valid),
		LBL_NO_RETURN,	LBL_SIZE(InstrumentCurrentName[2].Value)},	

	{"INSTRUMENT_CURRENT_NAME",		"STRING",		LBL_OPTIONAL,
		LBL_NO_CONT,	1,	4,	LBL_NULL,
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[3].Value),
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[3].Valid),
		LBL_NO_RETURN,	LBL_SIZE(InstrumentCurrentName[3].Value)},

	{"INSTRUMENT_CURRENT_NAME",		"STRING",		LBL_OPTIONAL,
		LBL_NO_CONT,	1,	5,	LBL_NULL,
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[4].Value),
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[4].Valid),
		LBL_NO_RETURN,	LBL_SIZE(InstrumentCurrentName[4].Value)},

	{"INSTRUMENT_CURRENT_NAME",		"STRING",		LBL_OPTIONAL,
		LBL_NO_CONT,	1,	6,	LBL_NULL,
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[5].Value),
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[5].Valid),
		LBL_NO_RETURN,	LBL_SIZE(InstrumentCurrentName[5].Value)},

	{"INSTRUMENT_CURRENT_NAME",		"STRING",		LBL_OPTIONAL,
		LBL_NO_CONT,	1,	7,	LBL_NULL,
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[6].Value),
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[6].Valid),
		LBL_NO_RETURN,	LBL_SIZE(InstrumentCurrentName[6].Value)},

	{"INSTRUMENT_CURRENT_NAME",		"STRING",		LBL_OPTIONAL,
		LBL_NO_CONT,	1,	8,	LBL_NULL,
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[7].Value),
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[7].Valid),
		LBL_NO_RETURN,	LBL_SIZE(InstrumentCurrentName[7].Value)},

	{"INSTRUMENT_CURRENT_NAME",		"STRING",		LBL_OPTIONAL,
		LBL_NO_CONT,	1,	9,	LBL_NULL,
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[8].Value),
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[8].Valid),
		LBL_NO_RETURN,	LBL_SIZE(InstrumentCurrentName[8].Value)},

	{"INSTRUMENT_CURRENT_NAME",		"STRING",		LBL_OPTIONAL,
		LBL_NO_CONT,	1,	10,	LBL_NULL,
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[9].Value),
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[9].Valid),
		LBL_NO_RETURN,	LBL_SIZE(InstrumentCurrentName[9].Value)},

	{"INSTRUMENT_CURRENT_NAME",		"STRING",		LBL_OPTIONAL,
		LBL_NO_CONT,	1,	11,	LBL_NULL,
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[10].Value),
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[10].Valid),
		LBL_NO_RETURN,	LBL_SIZE(InstrumentCurrentName[10].Value)},

	{"INSTRUMENT_CURRENT_NAME",		"STRING",		LBL_OPTIONAL,
		LBL_NO_CONT,	1,	12,	LBL_NULL,
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[11].Value),
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[11].Valid),
		LBL_NO_RETURN,	LBL_SIZE(InstrumentCurrentName[11].Value)},

	{"INSTRUMENT_CURRENT_NAME",		"STRING",		LBL_OPTIONAL,
		LBL_NO_CONT,	1,	13,	LBL_NULL,
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[12].Value),
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[12].Valid),
		LBL_NO_RETURN,	LBL_SIZE(InstrumentCurrentName[12].Value)},

	{"INSTRUMENT_CURRENT_NAME",		"STRING",		LBL_OPTIONAL,
		LBL_NO_CONT,	1,	14,	LBL_NULL,
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[13].Value),
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[13].Valid),
		LBL_NO_RETURN,	LBL_SIZE(InstrumentCurrentName[13].Value)},

	{"INSTRUMENT_CURRENT_NAME",		"STRING",		LBL_OPTIONAL,
		LBL_NO_CONT,	1,	15,	LBL_NULL,
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[14].Value),
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[14].Valid),
		LBL_NO_RETURN,	LBL_SIZE(InstrumentCurrentName[14].Value)},

	{"INSTRUMENT_CURRENT_NAME",		"STRING",		LBL_OPTIONAL,
		LBL_NO_CONT,	1,	16,	LBL_NULL,
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[15].Value),
		LBL_OFFSET(LblInstrumentState_typ, InstrumentCurrentName[15].Valid),
		LBL_NO_RETURN,	LBL_SIZE(InstrumentCurrentName[15].Value)},

        {"DEVICE_COMPONENT_STATE",              "INT",  LBL_OPTIONAL,
                LBL_NO_CONT,    1,      1,      LBL_NULL,
                LBL_OFFSET(LblInstrumentState_typ, DeviceComponentState[0].Value),
                LBL_OFFSET(LblInstrumentState_typ, DeviceComponentState[0].Valid),
                LBL_NO_RETURN,  LBL_SIZE(DeviceComponentState[0].Value)},

        {"DEVICE_COMPONENT_STATE",              "INT",  LBL_OPTIONAL,
                LBL_NO_CONT,    1,      2,      LBL_NULL,
                LBL_OFFSET(LblInstrumentState_typ, DeviceComponentState[1].Value),
                LBL_OFFSET(LblInstrumentState_typ, DeviceComponentState[1].Valid),
                LBL_NO_RETURN,  LBL_SIZE(DeviceComponentState[1].Value)},

        {"DEVICE_COMPONENT_STATE_NAME",         "STRING",  LBL_OPTIONAL,
                LBL_NO_CONT,    1,      1,      LBL_NULL,
                LBL_OFFSET(LblInstrumentState_typ, DeviceComponentStateName[0].Value),
                LBL_OFFSET(LblInstrumentState_typ, DeviceComponentStateName[0].Valid),
                LBL_NO_RETURN,  LBL_SIZE(DeviceComponentStateName[0].Value)},

        {"DEVICE_COMPONENT_STATE_NAME",         "STRING",  LBL_OPTIONAL,
                LBL_NO_CONT,    1,      2,      LBL_NULL,
                LBL_OFFSET(LblInstrumentState_typ, DeviceComponentStateName[1].Value),
                LBL_OFFSET(LblInstrumentState_typ, DeviceComponentStateName[1].Valid),
                LBL_NO_RETURN,  LBL_SIZE(DeviceComponentStateName[1].Value)},

        {"FILTER_POSITION_COUNT",                       "INT",          LBL_OPTIONAL,
                LBL_NO_CONT,    1,      1,      LBL_NULL,
                LBL_OFFSET(LblInstrumentState_typ, FilterPositionCount.Value),
                LBL_OFFSET(LblInstrumentState_typ, FilterPositionCount.Valid),
                LBL_NO_RETURN,  LBL_SIZE(FilterPositionCount.Value)},

        {"ZOOM_POSITION_COUNT",                       "INT",          LBL_OPTIONAL,
                LBL_NO_CONT,    1,      1,      LBL_NULL,
                LBL_OFFSET(LblInstrumentState_typ, ZoomPositionCount.Value),
                LBL_OFFSET(LblInstrumentState_typ, ZoomPositionCount.Valid),
                LBL_NO_RETURN,  LBL_SIZE(ZoomPositionCount.Value)},

        {"FOCAL_LENGTH",                       "REAL",          LBL_OPTIONAL,
                LBL_NO_CONT,    1,      1,      LBL_NULL,
                LBL_OFFSET(LblInstrumentState_typ, FocalLength.Value),
                LBL_OFFSET(LblInstrumentState_typ, FocalLength.Valid),
                LBL_NO_RETURN,  LBL_SIZE(FocalLength.Value)},

        {"FOCAL_LENGTH__UNIT",                   "STRING",       LBL_OPTIONAL,
                LBL_NO_CONT,    1,      1,      LBL_NULL,
                LBL_OFFSET(LblInstrumentState_typ, FocalLengthUnit.Value),
                LBL_OFFSET(LblInstrumentState_typ, FocalLengthUnit.Valid),
                LBL_NO_RETURN,  LBL_SIZE(FocalLengthUnit.Value)},

        {"SPECIAL_LINE",                       "INT",          LBL_OPTIONAL,
                LBL_NO_CONT,    1,      1,      LBL_NULL,
                LBL_OFFSET(LblInstrumentState_typ, SpecialLine.Value),
                LBL_OFFSET(LblInstrumentState_typ, SpecialLine.Valid),
                LBL_NO_RETURN,  LBL_SIZE(SpecialLine.Value)},

        {"SPECIAL_NAME",                       "STRING",          LBL_OPTIONAL,
                LBL_NO_CONT,    1,      1,      LBL_NULL,
                LBL_OFFSET(LblInstrumentState_typ, SpecialName.Value),
                LBL_OFFSET(LblInstrumentState_typ, SpecialName.Valid),
                LBL_NO_RETURN,  LBL_SIZE(SpecialName.Value)},

        {"SPECIAL_SAMPLE",                       "INT",          LBL_OPTIONAL,
                LBL_NO_CONT,    1,      1,      LBL_NULL,
                LBL_OFFSET(LblInstrumentState_typ, SpecialSample.Value),
                LBL_OFFSET(LblInstrumentState_typ, SpecialSample.Valid),
                LBL_NO_RETURN,  LBL_SIZE(SpecialSample.Value)},

        {"HDR_EXPOSURE_TIME_DELTA",               "INT",         LBL_OPTIONAL,
            LBL_NO_CONT,    1,      1,      LBL_NULL,
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDelta[0].Value),
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDelta[0].Valid),
            LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDelta[0].Value)},
    
        {"HDR_EXPOSURE_TIME_DELTA",               "INT",         LBL_OPTIONAL,
            LBL_NO_CONT,    1,      2,      LBL_NULL,
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDelta[1].Value),
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDelta[1].Valid),
            LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDelta[1].Value)},
    
        {"HDR_EXPOSURE_TIME_DELTA",               "INT",         LBL_OPTIONAL,
            LBL_NO_CONT,    1,      3,      LBL_NULL,
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDelta[2].Value),
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDelta[2].Valid),
            LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDelta[2].Value)},
    
        {"HDR_EXPOSURE_TIME_DELTA",               "INT",         LBL_OPTIONAL,
            LBL_NO_CONT,    1,      4,      LBL_NULL,
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDelta[3].Value),
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDelta[3].Valid),
            LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDelta[3].Value)},
    
        {"HDR_EXPOSURE_TIME_DELTA",               "INT",         LBL_OPTIONAL,
            LBL_NO_CONT,    1,      5,      LBL_NULL,
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDelta[4].Value),
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDelta[4].Valid),
            LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDelta[4].Value)},
    
        {"HDR_EXPOSURE_TIME_DELTA",               "INT",         LBL_OPTIONAL,
            LBL_NO_CONT,    1,      6,      LBL_NULL,
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDelta[5].Value),
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDelta[5].Valid),
            LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDelta[5].Value)},

        {"HDR_EXPOSURE_TIME_DELTA",               "INT",         LBL_OPTIONAL,
            LBL_NO_CONT,    1,      7,      LBL_NULL,
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDelta[6].Value),
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDelta[6].Valid),
            LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDelta[6].Value)},

        {"HDR_EXPOSURE_TIME_DELTA__UNIT",               "STRING",         LBL_OPTIONAL,
            LBL_NO_CONT,    1,      1,      LBL_NULL,
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDeltaUnit[0].Value),
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDeltaUnit[0].Valid),
            LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDeltaUnit[0].Value)},

        {"HDR_EXPOSURE_TIME_DELTA__UNIT",               "STRING",         LBL_OPTIONAL,
            LBL_NO_CONT,    1,      2,      LBL_NULL,
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDeltaUnit[1].Value),
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDeltaUnit[1].Valid),
            LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDeltaUnit[1].Value)},

        {"HDR_EXPOSURE_TIME_DELTA__UNIT",               "STRING",         LBL_OPTIONAL,
            LBL_NO_CONT,    1,      3,      LBL_NULL,
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDeltaUnit[2].Value),
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDeltaUnit[2].Valid),
            LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDeltaUnit[2].Value)},

        {"HDR_EXPOSURE_TIME_DELTA__UNIT",               "STRING",         LBL_OPTIONAL,
            LBL_NO_CONT,    1,      4,      LBL_NULL,
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDeltaUnit[3].Value),
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDeltaUnit[3].Valid),
            LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDeltaUnit[3].Value)},

        {"HDR_EXPOSURE_TIME_DELTA__UNIT",               "STRING",         LBL_OPTIONAL,
            LBL_NO_CONT,    1,      5,      LBL_NULL,
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDeltaUnit[4].Value),
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDeltaUnit[4].Valid),
            LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDeltaUnit[4].Value)},

        {"HDR_EXPOSURE_TIME_DELTA__UNIT",               "STRING",         LBL_OPTIONAL,
            LBL_NO_CONT,    1,      6,      LBL_NULL,
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDeltaUnit[5].Value),
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDeltaUnit[5].Valid),
            LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDeltaUnit[5].Value)},

        {"HDR_EXPOSURE_TIME_DELTA__UNIT",               "STRING",         LBL_OPTIONAL,
            LBL_NO_CONT,    1,      7,      LBL_NULL,
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDeltaUnit[6].Value),
            LBL_OFFSET(LblInstrumentState_typ, HdrExposureTimeDeltaUnit[6].Valid),
            LBL_NO_RETURN,  LBL_SIZE(HdrExposureTimeDeltaUnit[6].Value)},

        {"HDR_FRAME_COUNT",               "INT",         LBL_OPTIONAL,
            LBL_NO_CONT,    1,      1,      LBL_NULL,
            LBL_OFFSET(LblInstrumentState_typ, HdrFrameCount.Value),
            LBL_OFFSET(LblInstrumentState_typ, HdrFrameCount.Valid),
            LBL_NO_RETURN,  LBL_SIZE(HdrFrameCount.Value)},
            
    {"DC_OFFSET",                            "INT",          LBL_OPTIONAL,
                LBL_NO_CONT,    1,      1,      LBL_NULL,
                LBL_OFFSET(LblInstrumentState_typ, DCOffset.Value),
                LBL_OFFSET(LblInstrumentState_typ, DCOffset.Valid),
                LBL_NO_RETURN,  LBL_SIZE(DCOffset.Value)},

    {"ORIGINAL_SAMPLE_BITS",                            "INT",          LBL_OPTIONAL,
                LBL_NO_CONT,    1,      1,      LBL_NULL,
                LBL_OFFSET(LblInstrumentState_typ, OriginalSampleBits.Value),
