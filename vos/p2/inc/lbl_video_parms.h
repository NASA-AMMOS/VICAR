#ifndef MIPS_LBL_VIDEO_PARMS_INCLUDED
#define MIPS_LBL_VIDEO_PARMS_INCLUDED 1
...
typedef struct
	...
	LblApiTypeItem_typ      FrameRateUnit;
	LblApiRealItem_typ      FrameTime;
	LblApiTypeItem_typ      FrameTimeUnit;
...
int	LblVideoParms( int, int, LblVideoParms_typ *, int );
void	LblTestVideoParms( LblVideoParms_typ *);
void	LblPrintVideoParms( LblVideoParms_typ *);
