...
c Match two image areas by fitting the DN values to an bilinear model but allowing
c only the first 6 coefficients to vary.
c
...
c
      subroutine match_affine1(nl,ns,I2,l0,s0,lmax,eps,nlw,nsw,
