...
c Match two image areas by fitting the DN values to an bilinear model
c but only allowing a0 and b0 to vary.
c
...
c
      subroutine match_offset1(nl,ns,I2,l0,s0,lmax,eps,nlw,nsw,
...
c      call xvmessage('Entering match_offset',' ')
