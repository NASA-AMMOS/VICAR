...
PigColorModelPsyche::PigColorModelPsyche(const char *mission,
...
PigColorModelPsyche::PigColorModelPsyche() : PigColorModel()
{
    _host_id = _prefix = NULL;
}
...
PigColorModelPsyche::~PigColorModelPsyche()
{
...
PigColorModelPsyche *PigColorModelPsyche::create(PigFileModel *file)
{
    PigMission *m = PigMission::getMissionObject(file);
    return new PigColorModelPsyche(file->getMissionName(),
...
int PigColorModelPsyche::constructPrefix()
{
...
double PigColorModelPsyche::getStaticColorScalingFactor(char *config_file,
                                                     char *prefix)
{
    FILE *inClientFile;
    char pre[256];
