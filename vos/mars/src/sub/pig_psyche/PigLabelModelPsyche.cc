...
// PigLabelModelPsyche
//
// Psyche-specific class for Label models.  Responsible for maintaining an output
...
const char* PigLabelModelPsyche::inst_values[] = 
    { "DRILL","GDRT","SHERLOC_WATSON","SHERLOC","PIXL", "FCS" };

const char* PigLabelModelPsyche::config_values[] = 
...
PigLabelModelPsyche::PigLabelModelPsyche(int unit, const char *mission)
              :PigLabelModel(unit, mission)
{
}

PigLabelModelPsyche::~PigLabelModelPsyche()
{
}
...
int PigLabelModelPsyche::setReach(PigFileModel *file_models[], int nids)
{    
...
int PigLabelModelPsyche::setGReach(PigFileModel *file_models[], int nids,
...
int PigLabelModelPsyche::setPreload(PigFileModel *file_models[], int nids,
				 int preload_type)
{    
    // basic items
...
int PigLabelModelPsyche::setRough(PigFileModel *file_models[], int nids,
...
/////////////////////////////////////////////////////////////////////////////
// Returns Rover Motion Counter(RMC) index name.  For Psyche, we have 2 indices,
// named (SITE, DRIVE).
/////////////////////////////////////////////////////////////////////////////
char* PigLabelModelPsyche::getCoordSysIndexName(int index)
{
    switch(index) {
        case 0: {
	  return "SITE";
