...
PigPointPHXssiCamera3dof::PigPointPHXssiCamera3dof(PigCameraModel *cm,
						   PigMission *mission, 
						   const char *instrument)
                        : PigPointPHXssiCamera(cm, mission, instrument)
{
    _twist = 0.0;
}
...
PigPointPHXssiCamera3dof::~PigPointPHXssiCamera3dof()
{
	// nothing to do...
}
...
void PigPointPHXssiCamera3dof::pointCamera(const double az,
					   const double el,
					   const double twist,
					   PigCoordSystem *cs )
{
...
void PigPointPHXssiCamera3dof::getPointingParameters(double params[],
						 const int max_count)
{
    if (max_count >= 1)
	params[0] = _azimuth;
...
void PigPointPHXssiCamera3dof::setPointingParameters(const double params[],
						     const int count)
{
...
const char *const PigPointPHXssiCamera3dof::getPointingParamName(int i)
{
    switch (i) {
        case 0:
            return "Azimuth";
...
void PigPointPHXssiCamera3dof::forceCameraRepoint( )
{
...
void PigPointPHXssiCamera3dof::getPointingErrorEstimate(double errors[],
							const int max_count)
{
