...
// look for the PHX RMC database files, passing each one to
// PSM::readSolutionFile.  If not, the original file is passed along to the
// superclass.
//
...
void PigRoverStateManagerPHX::readSolutionFile(char *filename,
