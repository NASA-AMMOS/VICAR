 ...
 *  a phx Coordinate property label.  It is part of the MIPL label API package,
...

/******************************************************************************
 *				PHX_LBL_SITE_COORDINATE
 *
 *****************************************************************************/
int     PhxLblSiteCoordinate(
  int   Unit,
  int   Obtain,
...

/******************************************************************************
 *				PHX_LBL_PAYLOAD_COORDINATE
 *
 *****************************************************************************/
int     PhxLblPayloadCoordinate(
  int   Unit,
  int   Obtain,
  LblCoordinate_typ      *LabelItems,
  int	Instance)
{
  LblSetCoordinate( "PAYLOAD_COORDINATE_SYSTEM" );
  return (LblCoordinateApi(Unit,Obtain,LabelItems,Instance,(const char*) NULL));
}

/******************************************************************************
 *				PHX_LBL_LOCAL_LEVEL_COORDINATE
 *
 *****************************************************************************/
int     PhxLblLocalLevelCoordinate(
  int   Unit,
  int   Obtain,
  LblCoordinate_typ      *LabelItems,
  int	Instance)
