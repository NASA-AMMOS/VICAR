...
#include "phx_lbl_derived_geometry.h"
...

/******************************************************************************
 *				PHX_LBL_ROVER_DERIVED_GEOMETRY
 *
 *****************************************************************************/
int     PhxLblPayloadDerivedGeometry(
  int   Unit,
  int   Obtain,
  LblDerivedGeometry_typ      *LabelItems,
  int	Instance )
{
  LblSetDerivedGeometry("PAYLOAD_DERIVED_GEOMETRY_PARMS");
  return (LblDerivedGeometryApi(Unit,Obtain,LabelItems,Instance,(const char*)NULL));
}

/******************************************************************************
 *				PHX_LBL_SITE_DERIVED_GEOMETRY
 *
 *****************************************************************************/
int     PhxLblSiteDerivedGeometry(
  int   Unit,
  int   Obtain,
  LblDerivedGeometry_typ      *LabelItems,
  int	Instance )
