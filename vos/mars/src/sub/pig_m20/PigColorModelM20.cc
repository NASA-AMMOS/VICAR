...
PigColorModelM20::PigColorModelM20(const char *mission,
...
PigColorModelM20::PigColorModelM20() : PigColorModel()
{
    _host_id = _prefix = NULL;
}
...
PigColorModelM20::~PigColorModelM20()
{
...
PigColorModelM20 *PigColorModelM20::create(PigFileModel *file)
{
    PigMission *m = PigMission::getMissionObject(file);
    return new PigColorModelM20(file->getMissionName(),
...
int PigColorModelM20::constructPrefix()
{
...
double PigColorModelM20::getStaticColorScalingFactor(char *config_file,
                                                     char *prefix)
{
    FILE *inClientFile;
    char pre[256];
