...
// PigFileModelColdarm
//
// Coldarm-specific File model.  This only needs to handle exceptions to the
...
PigFileModelColdarm::PigFileModelColdarm(const char *filename, 
				 int unit,
				 const char *mission)
...
PigFileModelColdarm::~PigFileModelColdarm()
{
}
...
//
// For Coldarm x and y offsets are always 0
////////////////////////////////////////////////////////////////////////

void PigFileModelColdarm::setupOffsets()
{
    _x_offset = 0;
    _y_offset = 0;
}
...
PIG_READ_LABEL_STRUCTURE(LblInstrumentState_typ, PigFileModelColdarm,
...
float PigFileModelColdarm::getInstrumentTemperature(float def)
{						// InstrumentState
...
float PigFileModelColdarm::getInstrumentTemperature(float def, int use_partner)
{
    if (_lblInstrumentState == NULL)
        getLblInstrumentState();
    if (_lblInstrumentState == NULL)
    ...
    if (!strcmp(inst_id, "CONTEXT_LEFT"))
	strcpy(partner_inst_id, "CONTEXT_RIGHT");
    else if (!strcmp(inst_id, "CONTEXT_RIGHT"))
	strcpy(partner_inst_id, "CONTEXT_LEFT");
    else					// no partners
...
float PigFileModelColdarm::getInstrumentTemperatureFromName(
...
void PigFileModelColdarm::getRoverMotionCounter(int indices[], int &num_indices)
{   
...
////////////////////////////////////////////////////////////////////////
int PigFileModelColdarm::getRoverMotionCounterCount()
{
    return 4;
}
...
////////////////////////////////////////////////////////////////////////
char *PigFileModelColdarm::getRoverMotionCounterName(int index)
{
    static char *names[] = {
        "site", "drive", "pose", "arm"
    };
