...
//
// Coldarm-specific class for Label models.  Responsible for maintaining an output
...
//!!!! M20 VALUES AS PLACEHOLDER

const char* PigLabelModelColdarm::inst_values[] = 
    { "DRILL","GDRT","SHERLOC_WATSON","SHERLOC","PIXL", "FCS" };

const char* PigLabelModelColdarm::config_values[] = 
...
PigLabelModelColdarm::PigLabelModelColdarm(int unit, const char *mission)
              :PigLabelModel(unit, mission)
{
}

PigLabelModelColdarm::~PigLabelModelColdarm()
{
}
...
//!!!!!!!! NOT UPDATED FROM M20 !!!!!!!!

int PigLabelModelColdarm::setReach(PigFileModel *file_models[], int nids)
{    
...
int PigLabelModelColdarm::setGReach(PigFileModel *file_models[], int nids,
...
int PigLabelModelColdarm::setPreload(PigFileModel *file_models[], int nids,
				 int preload_type)
{    
    // basic items
...
int PigLabelModelColdarm::setRough(PigFileModel *file_models[], int nids,
...
/////////////////////////////////////////////////////////////////////////////
// Returns Rover Motion Counter(RMC) index name.  For Coldarm, we have 4 indices,
// named (SITE, DRIVE, POSE, ARM).
/////////////////////////////////////////////////////////////////////////////
char* PigLabelModelColdarm::getCoordSysIndexName(int index)
{
    switch(index) {
        case 0: {
	  return "SITE";
