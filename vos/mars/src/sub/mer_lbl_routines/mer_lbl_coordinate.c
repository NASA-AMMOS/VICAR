 ...
 *  a MER Coordinate property label.  It is part of the MIPL label API package,
...

/******************************************************************************
 *				MER_LBL_IDD_COORDINATE
 *
 *****************************************************************************/
int     MerLblIddCoordinate(
  int   Unit,
  int   Obtain,
  LblCoordinate_typ      *LabelItems,
  int	Instance)
{
  LblSetCoordinate( "IDD_COORDINATE_SYSTEM" );
  return (LblCoordinateApi(Unit,Obtain,LabelItems,Instance,(const char*)NULL));
}

/******************************************************************************
 *				MER_LBL_LOCAL_LEVEL_COORDINATE
 *
 *****************************************************************************/
int     MerLblLocalLevelCoordinate(
  int   Unit,
  int   Obtain,
  LblCoordinate_typ      *LabelItems,
  int	Instance)
{
  LblSetCoordinate( "LOCAL_LEVEL_COORDINATE_SYSTEM" );
  return (LblCoordinateApi(Unit,Obtain,LabelItems,Instance,(const char*)NULL));
}

/******************************************************************************
 *				MER_LBL_PMA_COORDINATE
 *
 *****************************************************************************/
int     MerLblPmaCoordinate(
  int   Unit,
  int   Obtain,
  LblCoordinate_typ      *LabelItems,
  int	Instance)
{
  LblSetCoordinate( "PMA_COORDINATE_SYSTEM" );
  return (LblCoordinateApi(Unit,Obtain,LabelItems,Instance,(const char*)NULL));
}

/******************************************************************************
 *				MER_LBL_ROVER_COORDINATE
 *
 *****************************************************************************/
int     MerLblRoverCoordinate(
  int   Unit,
  int   Obtain,
  LblCoordinate_typ      *LabelItems,
  int	Instance)
{
  LblSetCoordinate( "ROVER_COORDINATE_SYSTEM" );
  return (LblCoordinateApi(Unit,Obtain,LabelItems,Instance,(const char*)NULL));
}

/******************************************************************************
 *				MER_LBL_SITE_COORDINATE
 *
 *****************************************************************************/
int     MerLblSiteCoordinate(
  int   Unit,
  int   Obtain,
  LblCoordinate_typ      *LabelItems,
  int	Instance)
{
  LblSetCoordinate( "SITE_COORDINATE_SYSTEM" );
  return (LblCoordinateApi(Unit,Obtain,LabelItems,Instance,(const char*)NULL));
}
