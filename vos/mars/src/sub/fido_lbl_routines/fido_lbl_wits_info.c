...
#define  LBL_SIZE(x)	sizeof(((FidoLblWitsInfo_typ*)0)->x)

static LblApiElement_typ	LabelTbl[] = {
	{"MAST_JOINT1_ANGLE",	"REAL",		LBL_OPTIONAL,
		LBL_NO_CONT,	1,	1,	LBL_NULL,
		LBL_OFFSET(FidoLblWitsInfo_typ, MastJoint1Angle.Value),
		LBL_OFFSET(FidoLblWitsInfo_typ, MastJoint1Angle.Valid),
		LBL_NO_RETURN,	LBL_SIZE(MastJoint1Angle.Value)},

	{"MAST_JOINT2_ANGLE",	"REAL",		LBL_OPTIONAL,
		LBL_NO_CONT,	1,	1,	LBL_NULL,
		LBL_OFFSET(FidoLblWitsInfo_typ, MastJoint2Angle.Value),
		LBL_OFFSET(FidoLblWitsInfo_typ, MastJoint2Angle.Valid),
		LBL_NO_RETURN,	LBL_SIZE(MastJoint2Angle.Value)},

	{"MAST_JOINT3_ANGLE",	"REAL",		LBL_OPTIONAL,
		LBL_NO_CONT,	1,	1,	LBL_NULL,
		LBL_OFFSET(FidoLblWitsInfo_typ, MastJoint3Angle.Value),
		LBL_OFFSET(FidoLblWitsInfo_typ, MastJoint3Angle.Valid),
		LBL_NO_RETURN,	LBL_SIZE(MastJoint3Angle.Value)},

	{"MAST_JOINT4_ANGLE",	"REAL",		LBL_OPTIONAL,
		LBL_NO_CONT,	1,	1,	LBL_NULL,
		LBL_OFFSET(FidoLblWitsInfo_typ, MastJoint4Angle.Value),
		LBL_OFFSET(FidoLblWitsInfo_typ, MastJoint4Angle.Valid),
		LBL_NO_RETURN,	LBL_SIZE(MastJoint4Angle.Value)},
...
static LblApiProcess_typ	Label = {
	LabelTbl,       "PROPERTY",     "PROPERTY",     "FIDO_WITS_INFO",
	LBL_NULL };

/******************************************************************************
 *				MPL_LBL_WITS_INFO
...
int     FidoLblWitsInfo(
  int   Unit,
  int   Obtain,
  FidoLblWitsInfo_typ      *LabelItems,
  int	Instance)
{ int   RtnStatus;
  LblApiCntrl_typ	Cntrl;

  Label.Buffer = (void *)LabelItems;
  Label.BufferSize = sizeof(FidoLblWitsInfo_typ);
