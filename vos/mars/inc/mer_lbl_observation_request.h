#ifndef MIPS_MER_LBL_OBSERVATION_REQUEST_INCLUDED
#define MIPS_MER_LBL_OBSERVATION_REQUEST_INCLUDED 1
 ...
 * -----------  --------------- ---------------------------------------------
 * 2003-Feb-10	Payam Zamani	Added FilterName
 * 2003-01-10	P. Zamani	Change FilterNumber back to LblApiIntItem
 * 2003-01-08   P. Zamani       Changed type of FilterNumber to LblApiIdItem_typ
 *****************************************************************************/
...
typedef struct
	...
	} MerLblObsRequest_typ;

int	MerLblObservationRequest( int, int, MerLblObsRequest_typ *, int );
void	MerLblTestObservationRequest( MerLblObsRequest_typ *);
void	MerLblPrintObservationRequest( MerLblObsRequest_typ *);
