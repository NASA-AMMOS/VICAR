...
*/
#ifndef M2020MEDAPDS_H_
#define M2020MEDAPDS_H_
...
class M2020MedaPds {
   ...
   string prodName_, instrId_, config_, venue_, prodType_, seqId_, who_, ver_, ext_, sclk_, sol_;
   int site_, drive_;
   ...
   ~M2020MedaPds();
    M2020MedaPds(M2020DpMetaData *, char *instr);
