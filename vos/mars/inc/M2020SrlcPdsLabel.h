...
#ifndef M2020SRLCPDSLABEL_H_
#define M2020SRLCPDSLABEL_H_
...
class M2020SrlcPdsLabel {
   ...
   explicit M2020SrlcPdsLabel(M2020DpMetaData *, M2020ImgEdr * edr, char *instr, string edr_type);
   virtual ~ M2020SrlcPdsLabel();
