#ifndef MIPS_MER_LBL_COORDINATE_INCLUDED
#define MIPS_MER_LBL_COORDINATE_INCLUDED 1
...
/***  Function prototypes  ***/
int	MerLblIddCoordinate( int, int, LblCoordinate_typ *, int );
int	MerLblLocalLevelCoordinate( int, int, LblCoordinate_typ *, int );
int	MerLblPmaCoordinate( int, int, LblCoordinate_typ *, int );
int	MerLblRoverCoordinate( int, int, LblCoordinate_typ *, int );
int	MerLblSiteCoordinate( int, int, LblCoordinate_typ *, int );
