#ifndef MIPS_MPL_LBL_COMMAND_INCLUDED
#define MIPS_MPL_LBL_COMMAND_INCLUDED 1
...
typedef struct
	{
	LblApiIdItem_typ		LampStateId;
	LblApiDescItem_typ		RequestDescription;
	LblApiIdItem_typ		RequestId;
	LblApiNameItem_typ		RequestName;
	} MplLblCommand_typ;

int	MplLblCommand( int, int, MplLblCommand_typ *, int );
void	MplLblTestCommand( MplLblCommand_typ *);
void	MplLblPrintCommand( MplLblCommand_typ *);
