...
#ifndef M2020ENGIMGPDSLABEL_H_
#define M2020ENGIMGPDSLABEL_H_
...
class M2020EngImgPdsLabel {
   ...
   const M2020IdphHeader *mmmCamHdr_ = NULL;
      ...
      public:
    explicit M2020EngImgPdsLabel(M2020DpMetaData *, M2020ImgEdr * edr, char *instr);
    virtual ~ M2020EngImgPdsLabel();
