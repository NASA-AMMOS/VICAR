...
////////////////////////////////////////////////////////////////////////
#ifndef PIGFILEMODELCOLDARM_H
#define PIGFILEMODELCOLDARM_H

#include "PigFileModel.h"

class PigFileModelColdarm : public PigFileModel {
  ...
  public:
    ...
    PigFileModelColdarm(const char *filename, int unit, const char *mission);
    virtual ~PigFileModelColdarm();
  ...
  public:
    ...
    // Coldarm implementation takes advantage of knowing that clocks
    ...
    virtual const char *const getModelName() { return "FileModelColdarm"; }
