#ifndef MIPS_PHX_LBL_ARTICULATION_INCLUDED
#define MIPS_PHX_LBL_ARTICULATION_INCLUDED 1
...
/***  Function prototypes  ***/
int	PhxLblFilterArticulation( int, int, LblArticulation_typ *, int );
int	PhxLblSsiArticulation( int, int, LblArticulation_typ *, int );
int	PhxLblRacArticulation( int, int, LblArticulation_typ *, int );
int	PhxLblOmArticulation( int, int, LblArticulation_typ *, int );
int	PhxLblRaArticulation( int, int, LblArticulation_typ *, int );
