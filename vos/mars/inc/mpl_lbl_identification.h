#ifndef MIPS_MPL_LBL_IDENTIFIER_INCLUDED
#define MIPS_MPL_LBL_IDENTIFIER_INCLUDED 1
...
typedef struct
	{
	LblApiIdItem_typ		ModuleId;
	LblApiIdItem_typ		ModuleVersionId;
	} MplLblIdentification_typ;


int	MplLblIdentification( int, int, MplLblIdentification_typ *, int );
void	MplLblPrintIdentification( MplLblIdentification_typ *);
void	MplLblTestIdentification( MplLblIdentification_typ *);
