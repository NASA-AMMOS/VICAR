#ifndef MIPS_FIDO_LBL_WITS_INFO_INCLUDED
#define MIPS_FIDO_LBL_WITS_INFO_INCLUDED 1
...
/******************************************************************************
 *				FIDO_LBL_INSTRUMENT_STATE
 *
 *	This module contains routines to help create, read/write and print an
 *  FIDO WITS INFO property label.  It is part of the MIPL label API package,
...
#define  FIDO_LBL_ROVER_TEMPS		20

typedef struct
	{
	LblApiRealItem_typ		MastJoint1Angle;
	LblApiRealItem_typ		MastJoint2Angle;
	LblApiRealItem_typ		MastJoint3Angle;
	LblApiRealItem_typ		MastJoint4Angle;
	} FidoLblWitsInfo_typ;

int	FidoLblWitsInfo( int, int, FidoLblWitsInfo_typ *, int );
void	FidoLblTestWitsInfo( FidoLblWitsInfo_typ *);
void	FidoLblPrintWitsInfo( FidoLblWitsInfo_typ *);
