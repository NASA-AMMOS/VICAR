#ifndef MIPS_MER_LBL_ARTICULATION_INCLUDED
#define MIPS_MER_LBL_ARTICULATION_INCLUDED 1
...
/***  Function prototypes  ***/
int	MerLblChassisArticulation( int, int, LblArticulation_typ *, int );
int	MerLblFilterArticulation( int, int, LblArticulation_typ *, int );
int	MerLblHgaArticulation( int, int, LblArticulation_typ *, int );
int	MerLblIddArticulation( int, int, LblArticulation_typ *, int );
int	MerLblPmaArticulation( int, int, LblArticulation_typ *, int );
