#ifndef MIPS_PHX_LBL_IMAGE_INCLUDED
#define MIPS_PHX_LBL_IMAGE_INCLUDED 1
...
typedef struct
	{
    LblApiIntItem_typ       FirstLineSample; //SubFrameXStart
    LblApiIntItem_typ       FirstLine; //SubFrameYStart
    LblApiIntItem_typ       LineSamples; //SubFrameXSize
    LblApiIntItem_typ       Lines; //SubFrameYSize
...
int	PhxLblImage( int, int, PhxLblImage_typ *, int );
void	PhxLblPrintImage( PhxLblImage_typ *);
void	PhxLblTestImage( PhxLblImage_typ *);
