#ifndef MIPS_PHX_LBL_COORDINATE_INCLUDED
#define MIPS_PHX_LBL_COORDINATE_INCLUDED 1
...
/***  Function prototypes  ***/
int	PhxLblSiteCoordinate( int, int, LblCoordinate_typ *, int );
int	PhxLblPayloadCoordinate( int, int, LblCoordinate_typ *, int );
int	PhxLblLocalLevelCoordinate( int, int, LblCoordinate_typ *, int );
