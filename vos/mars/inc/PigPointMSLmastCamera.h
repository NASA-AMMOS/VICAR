...
////////////////////////////////////////////////////////////////////////
#ifndef PIGPOINTMSLMASTCAMERA_H
#define PIGPOINTMSLMASTCAMERA_H
...
class PigPointMSLmastCamera : public PigPointingModel {
  ...
  public:
    ...
    PigPointMSLmastCamera(PigCameraModel *cm, 
			 PigMission *mission,
			 const char *instrument);
    virtual ~PigPointMSLmastCamera();
    ...
    virtual const char *const getModelName() { return "MSLmastCamera"; }
};
