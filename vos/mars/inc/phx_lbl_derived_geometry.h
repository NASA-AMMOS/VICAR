#ifndef MIPS_PHX_LBL_DERIVED_GEOMETRY_INCLUDED
#define MIPS_PHX_LBL_DERIVED_GEOMETRY_INCLUDED 1
...
/******************************************************************************
 *				PHX_LBL_DERIVED_GEOMETRY
 *
 *	This module contains routines to help create, read/write and print
 *  a PHX Derived Geometry label.  It is part of the MIPL label API package,
...
/***  Function Prototypes  ***/
int	PhxLblPayloadDerivedGeometry( int, int, LblDerivedGeometry_typ *, int );
int	PhxLblSiteDerivedGeometry( int, int, LblDerivedGeometry_typ *, int );
